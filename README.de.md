  ...
  <table>
    ...
    <tr>
      ...
      <td align="center">
        ...
        <br><sub><b>Kalender</b> - Google-OAuth, iCloud, CalDAV, Outlook-Push, ICS-Abos &amp; -Import</sub>
      </td>
    </tr>
    <tr>
      <td align="center">
...
| ![shopping](https://raw.githubusercontent.com/ulsklyc/yuvomi/main/docs/icons/shopping.png) | **Einkauf** | Gemeinsame, nach Gang gruppierte und passend zum eigenen Laden sortierte Listen mit Wischgesten und Ein-Tipp-Import aus dem Mahlzeitenplan. |
...
| ![calendar](https://raw.githubusercontent.com/ulsklyc/yuvomi/main/docs/icons/calendar.png) | **Kalender** | Zweiwege-Sync mit Google und CalDAV, einseitiger Outlook-Push via Microsoft Graph (outlook.com / M365 Family, mehrere Konten mit Auto-Sync je Konto), ICS-Abos, wiederkehrende Termine, Feiertags-Overlays und geteilte Sichtbarkeit. |
...
- **Einkauf** - Gemeinsame, nach Gang gruppierte Listen mit Wischgesten, Notizen je Artikel, Ein-Tipp-Import aus dem Mahlzeitenplan und der Übernahme aller abgehakten Artikel in den Vorrat. Beide Ebenen der Reihenfolge gehören dir: Zieh die Gänge in die Reihenfolge, in der du sie abgehst, und die Artikel innerhalb eines Gangs - oder verschieb sie mit den Pfeiltasten. Neue Artikel hängen sich ans Ende ihres Gangs, aus welchem Modul sie auch kommen. Artikel aus einer CalDAV-Erinnerungsliste zeigen deren Kategorien als Tags.
...
Wenn du Yuvomi in einem DSGVO-Kontext selbst hostest (EU/EWR, Verarbeitung fremder Daten), lies [docs/PRIVACY-FOR-SELFHOSTERS.md](docs/PRIVACY-FOR-SELFHOSTERS.md) vor dem Produktivbetrieb: Es behandelt Drittland-Bewertungen für jeden externen Dienst (Wetter, CalDAV/CardDAV, den Outlook-Push via Microsoft Graph, OIDC, WebDAV-Backup und Dokumentenspeicher), Hinweise zu Auftragsverarbeitungsverträgen, Empfehlungen zur Log-Aufbewahrung und eine Vorlage für das Verzeichnis von Verarbeitungstätigkeiten.
