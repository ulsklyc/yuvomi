...
function renderUpcomingEvents(events) {
  ...
  // KEINE BADGE: die Liste ist nach vorn offen und bei fuenf geschnitten, eine
  // Gesamtzahl gibt es nicht. „5" stuende genau so lange da, wie mindestens
  // fuenf Termine kommen - eine Zahl, die nur ihre eigene Obergrenze nennt.
  return `<div class="widget widget--calendar">
