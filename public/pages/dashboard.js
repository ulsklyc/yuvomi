...
import { canSeeWidget, moduleAccess, canUseFasting } from '/permissions.js';
...
const MODULE_FOR_WIDGET = { tasks: 'tasks', calendar: 'calendar', shopping: 'shopping', meals: 'meals', notes: 'notes', birthdays: 'birthdays', budget: 'budget', rewards: 'rewards', health: 'health', cycle: 'health', fasting: 'health', housekeeping: 'housekeeping', schedule: 'schedule' };
...
function renderFastingWidget(fasting) {
  if (!fasting) return `<div class="widget widget--fasting"><div class="widget__empty">${esc(t('health.fasting.loadError'))}</div></div>`;
