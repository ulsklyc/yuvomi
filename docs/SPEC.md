...
- Subscriptions API: `/api/v1/budget/subscriptions` CRUD and analytics; `/meta`, `/settings`, `/logo-search`; admin-only `/notification-agents` management and test endpoints.
